...
void shared_init(void) {
	...
	menuFont = load_font("Assets/font/blackjack.otf", fontSize);
	...
	PACMAN_WIN_SOUND = load_audio("Assets/Music/win_sound.mp3");
	PACMAN_POWERUP_SOUND = load_audio("Assets/Music/Powerup.mp3");
